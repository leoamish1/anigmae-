...
tokens = []
configData = {"prefix": ">","controllerAccountID":"790921244651552769", "anigameSniper": "on", "anigamePrefix": ".", "izziSniper": "on", "izziPrefix": "iz ", "latency": "off", "latency_": 0, "alerts": "on", "alertsChannel": "", "anigameLottery": "off", "anigameHourly": "off", "anigameBtAll": "off", "anigameRdBtAll":"off", "anigameLocClearer":"off","izziLottery": "off", "izziHourly": "off", "izziBtAll": "off","izziRdBtAll":"off", "izziEvBtAll":"off", "izziLocClearer":"off" , "featuresChannel": "", "commandsChannel": ""}
...
with open(".env","w") as t:
    for i in range(1,tokensLen+1):
        ...
        with open(f"accounts/{db}/rarityAlerts.json","w") as f:
            f.write('{"anigame": ["super rare", "ultra rare"], "izzi": ["diamond"]}')
        with open(f"accounts/{db}/timing.json","w") as f:
            f.write('{"anigameHourly": 3600, "anigameLottery": 610, "anigameBtAll": 1810, "anigameRdBtAll":1810, "anigameLocClearer":3610, "izziHourly": 3610, "izziLottery": 910, "izziBtAll": 1810, "izziRdBtAll":1810, "izziEvBtAll":1810, "izziLocClearer":3610 ,"spamDelay": 5}')
